...
our %config = (
  ...
  prefix => "C:\\Users\\User\\source\\dupfinder\\deps",
  processor => "",
...
our %target = (
  ...
  MT => "mt",
  MTFLAGS => "-nologo",
  RANLIB => "CODE(0x1cfbaf50a00)",
  RC => "rc",
  _conf_fname_int => [ "Configurations\\00-base-templates.conf", "Configurations\\00-base-templates.conf", "Configurations\\10-main.conf", "Configurations\\10-main.conf", "Configurations\\10-main.conf", "Configurations\\00-base-templates.conf", "Configurations\\00-base-templates.conf", "Configurations\\00-base-templates.conf", "Configurations\\10-main.conf", "Configurations\\shared-info.pl" ],
